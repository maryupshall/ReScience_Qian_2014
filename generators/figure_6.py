...
def figure6(ampa_scale=1 / 1000, nmda_scale=1 / 27200):  # todo refactor
    ...
    parameters_left_figures = {
        "nmda": [0, 60 * nmda_scale, 0],
        "ampa": [0, 2.3 * ampa_scale, 0],
        "i_app": [0, 0.16, 0],
    }
    parameters_right_figures = {
        "nmda": [0, 60 * nmda_scale, 0],
        "ampa": [0, 7 * ampa_scale, 0],
        "i_app": [0, 0.32, 0],
    }
    ...
    for iz, parameter_sets in enumerate(
        ...
        for ix, channel_type in enumerate(
            ["nmda", "ampa", "i_app"]
        ):  # iterate over type of channel nmda, ampa, inj.
            ...
            pattern = {
                0: channel_parameters[0],
                2000: channel_parameters[1],
                8000: channel_parameters[2],
            }  # at t=0 set parameter to p[0], at t=2000 set parameter to p[1]...
            ...
            solution, t_solved, stimulus = pulse(
                synapse_model, parameter, pattern, end_time, ic
            )
